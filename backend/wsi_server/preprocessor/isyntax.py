...
class Slide(SlideBase):
    ...
    def open(self) -> None:
        ...
        # self.dims = [self.get_dimension(lvl) for lvl in range(self.max_level)]  # <- comment this back in
        self.dims = [self.get_dimension(lvl) for lvl in range(8)]  # TODO - this is a hack so we can get level 5 out it
